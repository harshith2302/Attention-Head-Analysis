#!/usr/bin/env python3
"""
Clean Fix Script for lm-eval v0.4.1
Safely retries failed datasets without the need for TaskManager hacks.
"""
...
def run_single_task(lm, task_cfg, batch_size):
    import lm_eval
    # Clean v0.4.1 execution - no hacks needed!
...
def main():
    ...
    print("Loading model for clean fix (lm-eval v0.4.1)...")
